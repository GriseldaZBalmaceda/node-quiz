...
var DashboardComponent = /** @class */ (function () {
        ...
        this.http.get('/api/quiz/' + data).subscribe(function (res) {
            if (res) {
                ...
                var dialogRef = _this.dialog.open(_quiz_carousel_dialog_quiz_carousel_dialog_component__WEBPACK_IMPORTED_MODULE_3__["QuizCarouselDialogComponent"], {
                    width: '1000px',
                    height: '1000px',
                    data: { sentQuizId: { quizName: _this.quiz.quizName, quizId: _this.quiz.quizId } }
                });
    ...
    DashboardComponent.prototype.quizPage = function (id) {
...
var QuizComponent = /** @class */ (function () {
    function QuizComponent(route, router, cookieService, http, dialog) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.cookieService = cookieService;
...
var BaseLayoutComponent = /** @class */ (function () {
    function BaseLayoutComponent(route, router) {
        this.route = route;
        this.router = router;
    }
    BaseLayoutComponent.prototype.ngOnInit = function () {
    };
    BaseLayoutComponent.prototype.goToDash = function () {
        this.router.navigate(['/dashboard']);
    };
...
var SummaryResultsDialogComponent = /** @class */ (function () {
    ...
    SummaryResultsDialogComponent.prototype.goToDash = function () {
        this.router.navigate(['/dashboard']);
        this.dialogRef.close();
    };
    SummaryResultsDialogComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    ...
    return SummaryResultsDialogComponent;
}());
